...
def journalists_aude
	journalists.grep(/[Aa][Uu][Dd][Ee]/).count
end
...
###Passer l'Array en 1 string pour pouvoir compter les underscores###
def journalists_underscore
	journalists.to_s.count("_")
end

###Passer tous les charactères de l'Array en minuscule pour pouvoir ordonner###
